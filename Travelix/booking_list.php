...
if (!empty($user_id)) {
    ...
    <html>
        <head>
            <title>Booking List - Clever Traveler</title>
                    ...
                    <div class="col-md-8">
                        ...
                        <form class="form-light mt-20" role="form" method="post" action="">
                            <table class="table_list">                                                                
                                ...
                                <?php
                                $i = 0;
                                $sql_contact = "SELECT p.*, pa.*,u.name, u.email,u.phone_no from payments p join packages pa on pa.id = p.package_id join users u on p.user_id = u.id order by p.id desc";
