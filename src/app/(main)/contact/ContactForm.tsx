        ...
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          <div className="space-y-4">
            ...
            {CONTACT_INFO.map((item) => (
              <div key={item.title} className="flex items-start gap-4 p-4 rounded-2xl bg-muted/30 border border-border/50 hover:border-brand-200 transition-colors">
                <div className={`w-11 h-11 rounded-xl bg-gradient-to-br ${item.color} flex items-center justify-center shrink-0 shadow-sm`}>
          ...
          <div className="lg:col-span-2">
            {sent ? (
              <motion.div
                ...
                className="h-full flex flex-col items-center justify-center text-center p-14 bg-card rounded-2xl border border-border/60 shadow-sm"
              >
                <div className="w-20 h-20 rounded-full bg-green-100 dark:bg-green-950/40 flex items-center justify-center mb-5">
              ...
              <form onSubmit={handleSubmit} className="bg-card rounded-2xl border border-border/60 shadow-sm p-8 space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={5}
                    className="w-full px-4 py-3 rounded-xl border border-input bg-background text-sm font-medium placeholder:text-muted-foreground/50 placeholder:font-normal resize-none focus:outline-none focus:ring-2 focus:ring-brand-500/40 focus:border-brand-500 hover:border-brand-400/60 transition-all duration-200"
                  />
                </div>
